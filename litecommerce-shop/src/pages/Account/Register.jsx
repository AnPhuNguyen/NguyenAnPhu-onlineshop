...
export default function Register() {
    ...
    const field = (label, name, type = 'text', placeholder = '', icon) => (
        <div className="space-y-1.5">
            <label className="text-xs font-semibold uppercase tracking-wider text-[#737686]">{label}</label>
            <div className="flex items-center border border-[#c3c6d7] rounded-xl bg-gray-50 focus-within:border-[#004ac6] focus-within:ring-2 focus-within:ring-[#004ac6]/20 transition-all pr-3">
        ...
        <div className="min-h-screen bg-gradient-to-br from-[#e8eeff] via-[#f7f9fb] to-[#dbe1ff] flex items-center justify-center p-4">
            <div className="w-full max-w-md">
                <div className="text-center mb-8">
                    ...
                    <p className="text-[#737686] text-sm mt-2">Tạo tài khoản mới</p>
                </div>
